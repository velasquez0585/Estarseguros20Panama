...
#End Region
    ...
    '<AllowAnonymous()>
    '   <HttpGet()>
    Function AcercaDe() As ActionResult
        Return View()
    End Function
    ...
    Private Function obtener_menu_anonimos() As String
        ...
        'sbmenu.Append("<li><a href='/Home/Contactanos'>Contactanos</a></li>")
        sbmenu.Append("</ul>")
        ...
        If lista_vi_segaccperf.Count > 0 Then
            For m As Integer = 0 To lista_vi_segaccperf.Count - 1
                If modulo <> lista_vi_segaccperf(m).xnombrecortomod Then
                    ...
                    '            sbmenu.Append("<li class='clear-both'><a href='#'>" & lista_vi_segaccperf(s).xnombrecortosubmod & "</a>")
                    '            submodulo = lista_vi_segaccperf(s).xnombrecortuosbmod
                    sbmenu.Append("<ul>")
                    For p As Integer = 0 To lista_vi_segaccperf.Count - 1
                        ...
                        sbmenu.Append("<li class='clear-both'><a href='" & lista_vi_segaccperf(p).xdirurl & "'>" & lista_vi_segaccperf(p).xnombrecortoprog & "</a></li>")
                        'End If
                    Next p
                    sbmenu.Append("</ul>")
                    sbmenu.Append("</li>")
