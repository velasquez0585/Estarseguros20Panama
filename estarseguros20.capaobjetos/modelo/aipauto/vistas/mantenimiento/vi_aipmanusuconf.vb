...
Namespace aipauto.modelo.dbestarseguros20.vistas.mantenimiento
    ...
    Public Class petivi_aipmanusuconfpaglist

        Private p_pagvi_aipmanusuconf As paginacion
        Private p_vi_aipmanusuconf As vi_aipmanusuconf

        Public Property pagvi_aipmanusuconf() As paginacion
            Get
                Return Me.p_pagvi_aipmanusuconf
            End Get
            Set(ByVal Value As paginacion)
                Me.p_pagvi_aipmanusuconf = Value
            End Set
        End Property

        Public Property vi_aipmanusuconf() As vi_aipmanusuconf
            Get
                Return Me.p_vi_aipmanusuconf
            End Get
            Set(ByVal Value As vi_aipmanusuconf)
                Me.p_vi_aipmanusuconf = Value
            End Set
        End Property
    End Class

    Public Class respvi_aipmanusuconfpaglist

        Private p_pagvi_aipmanusuconf As paginacion
        Private p_lista_vi_aipmanusuconf As List(Of vi_aipmanusuconf)
        ...
        Public Property lista_vi_aipmanusuconf() As List(Of vi_aipmanusuconf)
            Get
                Return Me.p_lista_vi_aipmanusuconf
            End Get
            Set(ByVal Value As List(Of vi_aipmanusuconf))
                Me.p_lista_vi_aipmanusuconf = Value
            End Set
        End Property
    End Class
