...
<script type="text/javascript">
    function vmmanperitosbuscar1() {
        ...
        self.editar = function (obj) {
            ...
            postajaxjsonbasico("/Seguridad/ObtenerPorIdViUsu/?idsegmanusu=" + obj.idsegmanusu(), '{}', function (vi_segmanusu) {
                vmmanperitoseditar1.cargar(vi_segmanusu);
                ...
                $("#tab_manperitos").tabs("option", "active", 3);
            })
        }
    ...
    vmmanperitosbuscar1.prototype.toJSON = function () {
