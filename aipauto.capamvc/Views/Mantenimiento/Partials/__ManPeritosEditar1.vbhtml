...
<script type="text/javascript">
    function vmmanperitoseditar1() {
        ...
        self.actualizar = function () {
            ...
            postajaxjsonbasico("/Mantenimiento/ModificarUsuarioPerito/?xcodimmandisp=" + self.xcodimmandisp(), ko.toJSON(self.vi_segmanusu), function (respopera) {
