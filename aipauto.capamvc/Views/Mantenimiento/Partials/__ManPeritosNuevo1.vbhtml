...
<script type="text/javascript">
    function vmmanperitosnuevo1() {
        ...
        self.agregar = function () {
            ...
            //sel.xcodimmandisp
            //postajaxjsonbasico("/Mantenimiento/AgregarUsuarioPerito/", ko.toJSON(self.vi_segmanusu), function (respopera) {
            postajaxjsonbasico("/Mantenimiento/AgregarUsuarioPerito/?xcodimmandisp=" + self.xcodimmandisp(), ko.toJSON(self.vi_segmanusu), function (respopera) {
                if (respopera.irespuesta == 1) {
                    generar_noty_auto(respopera.xmsjusuario, "success");
                    self.limpiar();
                    vmmanperitosbuscar1.buscar();
                } else {
