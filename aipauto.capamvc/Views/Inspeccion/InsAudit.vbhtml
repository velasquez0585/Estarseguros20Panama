@Code
    ViewData("Title") = "Inspecciones por auditor"
    ViewData("Message") = "Inspecciones por auditor"
End Code
...
<section class="featured">
    <div class="content-wrapper">
        ...
        <p> 
            Realice auditoria y seguimiento de todas las inspecciones procesadas por el perito y 
...
@Html.Action("InsAudit", "Inspeccion", New With {.esvistaparcial = True})