@Code
    ViewData("Title") = "Consulta inspecciones por auditor"
    ViewData("Message") = "Consulta inspecciones por auditor"
End Code
...
<section class="featured">
    <div class="content-wrapper">
        ...
        <p> 
            Consulte todos los casos pendientes por cada auditor de la aplicación.
        </p>
    </div>
</section>
End Section 
...
@Scripts.Render("~/publico/scripts/sitfx/viewmodels/inspeccion/vi_aipinsauditagrup.js")
...
@Html.Action("InsConsCasosPorAudit", "Inspeccion", New With {.esvistaparcial = True})