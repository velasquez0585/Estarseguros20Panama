    ...
    <div data-bind="with: vi_aipinsenc">
        <div class="form-row">
            ...
            <div class="form-column">
                ...
                <div class="form-field-content">
                    <input placeholder="Ej: repuesto" type="text" data-bind="numeralvalue: xcedpropinsenc" />
                </div>
        ...
        <div class="form-row">
            ...
            <div class="form-column">
                <div class="form-field-header">
                    <label>Siniestro o Cotización:</label>
                </div>
                <div class="form-field-content">
                    <input placeholder="Ej: 123" type="text" data-bind="value: xnumsininsenc" />
                </div>
            </div>
            <div class="form-column">
                <div class="form-field-header">
            ...
            <table class="grid-table" data-bind='visible: lista_vi_aipinsenc().length > 0'>
                ...
                <tbody data-bind='foreach: lista_vi_aipinsenc'>
                    <tr class="grid-row-content">
                        <td>
                            <input type="button" value="Eliminar" data-bind="click: $root.eliminar, visible: $root.boton_eliminar " />
...
<script type="text/javascript">
    function vmInsConsAdminBuscar1(btnEliminar) {
        ...
        self.boton_eliminar = ko.observable(btnEliminar);
        ...
        self.buscar = function () {
            postajaxjsonbasico("/Inspeccion/ObtenerInspeccionMenosProcedentes/", ko.toJSON(self), function (peti) {
        ...
        self.eliminar = function (obj) {
            if (confirm("Desea Eliminar esta inspección?")) {
                postajaxjsonbasico("/Inspeccion/EliminarInspeccion/?idaipinsenc=" + obj.idaipinsenc(), "", function (respopera) {
