...
<div id="tab_insadminactperitmasiva" class="tab">
    <ul>
    ...
    <div id="tab-1">
        ...
        <div id="div_insadminactperitmasivabuscar1">
            @Html.Partial("__InsAdminActPeritMasivaBuscar1")
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var vminsadminactperitmasivabuscar1 = new vminsadminactperitmasivabuscar1();
    ko.applyBindings(vminsadminactperitmasivabuscar1, $('#div_insadminactperitmasivabuscar1')[0]);
    $(function () {
        ...
        vminsadminactperitmasivabuscar1.cargar();
    });
    ...
    $(function () {
        ...
        $("#tab_insadminactperitmasiva").tabs({ disabled: [1, 3] });
