...
<div id="tab_Bare" class="tab">
    ...
    <div id="tab-1">
        <div id="div_InsConsAuditBuscar1">
            @Html.Partial("__InsConsAuditBuscar1")
        </div>
    </div> 
...
<script type="text/javascript">
    var vmInsConsAuditBuscar1 = new vmInsConsAuditBuscar1(true, true, true);
    ko.applyBindings(vmInsConsAuditBuscar1, $('#div_InsConsAuditBuscar1')[0]);
