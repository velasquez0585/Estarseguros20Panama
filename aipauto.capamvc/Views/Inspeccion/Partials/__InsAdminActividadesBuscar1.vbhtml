<fieldset class="form-area" data-bind="with: vi_aipinsenc">
    ...
    <div class="form-column">
        <div class="form-field-header">
            ...
            <div class="form-field-content">                
                <select data-bind="options: $root.cboitipoaccion, optionsText: 'xvalordescripcion', optionsValue: 'xvalorcodigo', value: $root.itipoaccion, disable: $root.disabled_accion, event: {change: $root.evento_itipoaccion}"></select>
            </div>
        </div>
    </div>
    ...
    <div class="form-column">
        <div class="form-field-header">
            ...
            <div class="form-field-content">                
                <select data-bind="options: $root.cbosucursal, optionsText: 'xnombrecomercial', optionsValue: 'idsegmanorg', value: idsegmanorgperit, disable: $root.disabled_sucursal, event: { change: $root.evento_sucursal }"></select>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function vminsadminactividadesbuscar1() {
        var self = this;
        ...
        self.buscar = function (tipo) {
            ...
            if (self.valido()) {
                ...
                //if (self.vi_aipinsenc.idsegmanorgperit() == 0) {
                ...
                postajaxjsonbasico("/Inspeccion/ObtenerInspeccionesPorTipo/?itipoaccion=" + self.itipoaccion(), ko.toJSON(self), function (respvi_aipinsencpaglist) {
        ...
        self.limpiar = function () {
            self.vi_aipinsenc.idsegmanorgperit(0);
            self.itipoaccion("");            
        }
        ...
        self.llenarcbosucursal = function (idsegmanorg) {
            postajaxjsonbasico("/comun/ObtenerComboOrganizacion/", '{}', function (lista_vi_combosegmanorg) {
                ...
                self.vi_aipinsenc.idsegmanorgperit(idsegmanorg);
            });
        }
        ...
        //    if (self.vi_aipinsenc.idsegmanorgperit() > 0)
        //    {
        //        postajaxjsonbasico("/Seguridad/ObtenerComboUsuariosPorAccionYSuc/?idsegmanorg= " + self.vi_aipinsenc.idsegmanorgperit() + "&itipoaccion=" + self.itipoaccion(), '{}', function (lista_vi_segusudetperf2) {
        //            self.cbousuarios(lista_vi_segusudetperf2);
        //        });
        //    }
        //    else {
        //        postajaxjsonbasico("/Seguridad/ObtenerComboUsuariosPorAccion/?itipoaccion=" + self.itipoaccion(), '{}', function (lista_vi_segusudetperf2) {
        //            self.cbousuarios(lista_vi_segusudetperf2);
        //        });
        //    }           
        //}
    ...
    vminsadminactividadesbuscar1.prototype.toJSON = function () {
