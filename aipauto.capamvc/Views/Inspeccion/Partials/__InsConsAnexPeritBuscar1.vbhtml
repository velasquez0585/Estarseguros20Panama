    ...
    <div data-bind="with: vi_aipinsenc">
        <div class="form-row">
            ...
            <div class="form-column">
                ...
                <div class="form-field-content">
                    <input placeholder="Ej: 123" type="text" data-bind="value: xplacinsenc" />
                </div>
            </div>
            ...
            @*<div class="form-column">
                ...
                <div class="form-field-content">
                    <input placeholder="Ej: 4546AKHJ498" type="text" data-bind="value: xsermotinsenc" />
                </div>
            ...
            <div class="form-column">
                ...
                <div class="form-field-content">
                    <input placeholder="Ej: 4546AKHJ498" type="text" data-bind="value: xnumsininsenc" />
                </div>
...
<fieldset class="form-area">
    <legend>Lista de Siniestros</legend>
            ...
            <table class="grid-table" data-bind='visible: lista_vi_aipinsenc().length > 0'>
                ...
                <tbody data-bind='foreach: lista_vi_aipinsenc'>
                    <tr class="grid-row-content">
                        ...
                        <td>
                            <span data-bind='text: nanexoinsenc' />
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="button" value="Ver Ajuste" data-bind="click: $root.documento " />
...
<script type="text/javascript">
    function vmInsConsAnexPeritBuscar1(boton_ver, boton_agregar, boton_modificar) {
        var self = this;        
        ...
        self.encabezados_vi_aipinsenc = [                    
            { titulo: 'N° Siniestro', campo: 'it.xnumsininsenc' },
            { titulo: 'N° Ajuste', campo: 'it.nanexoinsenc' },
            ...
            { titulo: 'N° Inspección', campo: 'it.xnuminspinsenc' },                    
        ...
        self.buscar = function () {
            ...
            self.vi_aipinsenc.itipoinsenc("SINIESTRO");
            self.vi_aipinsenc.iestatinsenc("PROCEDENTE");//activar si despues de preguntar se queda en que solo muestre los que estan procedente, en simula no hay ningun caso
            if (self.vi_aipinsenc.xnuminspinsenc() != "" || self.vi_aipinsenc.xplacinsenc() != "" || self.vi_aipinsenc.xnumsininsenc() != "") {
        ...
        self.limpiar = function () {            
            ...
            self.vi_aipinsenc.xnuminspinsenc("");
        ...
        self.documento = function (obj) {
            switch (obj.itipoinsenc()) {
                ...
                case "SINIESTRO":
                    ...
                    vmInsSinGuardar1.iniciar(obj, false, true);
    ...
    vmInsConsAnexPeritBuscar1.prototype.toJSON = function () {
