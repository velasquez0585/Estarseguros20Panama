...
<div id="tab_Bare" class="tab">
    <ul>
        <li><a href="#tab-1">Lista</a></li>
    </ul>
    <div id="tab-1">
        <div id="div_InsPorProcLista1">
            @Html.Partial("__InsPorProcLista1")
        </div>
    </div>
...
<script type="text/javascript">
    var vmInsPorProcLista1 = new vmInsPorProcLista1(true, true, true);
    ko.applyBindings(vmInsPorProcLista1, $('#div_InsPorProcLista1')[0]);

    //var segu = $("#idsegmanperf").val();
    //if (segu == 2) {
        var vmInsRestGuardar1 = new vmInsRestGuardar1(true, false, false);
        ko.applyBindings(vmInsRestGuardar1, $('#dlg_InsRestGuardar1')[0]);
        var vmInsSusGuardar1 = new vmInsSusGuardar1(true, false, false);
        ko.applyBindings(vmInsSusGuardar1, $('#dlg_InsSusGuardar1')[0]);
        var vmInsLimDanSusGuardar1 = new vmInsLimDanSusGuardar1(true, false, false);
        ko.applyBindings(vmInsLimDanSusGuardar1, $('#dlg_InsLimDanSusGuardar1')[0]);
        var vmInsLimDanSinGuardar1 = new vmInsLimDanSinGuardar1(true, false, true);
        ko.applyBindings(vmInsLimDanSinGuardar1, $('#dlg_InsLimDanSinGuardar1')[0]);
        var vmInsAjusDanSinGuardar1 = new vmInsAjusDanSinGuardar1(true, false, true);
        ko.applyBindings(vmInsAjusDanSinGuardar1, $('#dlg_InsAjusDanSinGuardar1')[0]);
        var vmInsAjusDanAnexGuardar1 = new vmInsAjusDanAnexGuardar1(true, false, true);
        ko.applyBindings(vmInsAjusDanAnexGuardar1, $('#dlg_InsAjusDanAnexGuardar1')[0]);

        var vmInsSinGuardar1 = new vmInsSinGuardar1(true, false, false);
